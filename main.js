...
function addPoints(data) {
    ...
    function filterData () {
		...
		if ( mestarValue != 1 || mesendValue != 12) {document.querySelector("link[href='css/noSeleccionado.css']").href = "css/seleccionado.css";}
		else { document.querySelector("link[href='css/seleccionado.css']").href = "css/noSeleccionado.css"; }
